"""
Django settings for late_cell_47111 project.
...
ROOT_URLCONF = 'late_cell_47111.urls'
...
WSGI_APPLICATION = 'late_cell_47111.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_cell_47111 API",
    "DESCRIPTION": "API documentation for late_cell_47111 App",
    "VERSION": "v1",
}
